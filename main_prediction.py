...
def preprocess(data, flip=True):
    ...
    for col in range(numeric.shape[1]):
        if col == 0:
            numeric[:, col] = (numeric[:, col] - close_mean) / close_std
        else:
            numeric[:, col] = standardize(numeric[:, col])
...
"""
Epoch 85 | Train Loss: 0.006355 | Val Loss: 0.152872
Epoch 86 | Train Loss: 0.008061 | Val Loss: 0.131819
Early stopping triggered.
Finished Training
close_mean / close_std: 77.37342913570508 42.56908416354035
Test MSELoss: 0.027592899277806282
Test MAELoss: 0.6305859908577066
Test RMSE (actual price scale): 7.071197618659676
Test RMAE (actual price scale): 5.615198763069058
Predicted Next 5 Days: [117.5148930929762, 117.56828998353849, 117.50017391922877, 117.48107383913116, 117.3265640036272]
"""