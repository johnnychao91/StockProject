...
def preprocess(data, flip=True):
    ...
    numeric = np.array([row[1:24+1] for row in data]).astype(np.float64)
    # 1 ~ 24: 價格與技術面資料（含台灣股價），不含情緒
...
"""
Epoch 128 | Train Loss: 0.030635 | Val Loss: 0.107348
Epoch 129 | Train Loss: 0.026150 | Val Loss: 0.096991
Early stopping triggered.
Finished Training
close_mean / close_std: 77.37342913570508 42.56908416354035
Test MSELoss: 0.1577545702457428
Test MAELoss: 0.7788597462011413
Test RMSE (actual price scale): 16.907729135644107
Test RMAE (actual price scale): 14.921583417586493
"""