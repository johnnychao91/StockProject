...
class LSTMPredictor(nn.Module):
    def __init__(self, feature_dim, output_len=1, num_layers=2, dropout=0.3, bidirectional=False):
...
"""
Epoch 162 | Train Loss: 0.024373 | Val Loss: 0.037402
Epoch 163 | Train Loss: 0.022584 | Val Loss: 0.036939
Early stopping triggered.
Finished Training
close_mean / close_std: 77.37342913570508 42.56908416354035
Test MSELoss: 0.17763203382492065
Test MAELoss: 0.9237769093843696
Test RMSE (actual price scale): 17.9413430798006
Test RMAE (actual price scale): 17.24401937816804
"""